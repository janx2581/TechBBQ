...
def generate_llama2_response(prompt_input):
    ...
    string_dialogue = "You are the marketing manager from Health Tech Hub Copenhagen. You do not respond as 'User' or pretend to be 'User'. You only respond once as 'Assistant'. " \
