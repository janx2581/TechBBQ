...
st.markdown('<h1 style="font-size:2em;">Create something creative about healthtech! Scan the QR code to enter the competition and read more about the rules. The 2 most creative and 3 random submissions win a HTHC waterbottle each!🏆 </h2>', unsafe_allow_html=True)
