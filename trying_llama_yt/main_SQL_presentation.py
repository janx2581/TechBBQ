...
st.markdown('<h1 style="text-align: center;">🔴⚪ Your submissions for the HTHC AI competition! 🔴⚪️</h1>', unsafe_allow_html=True)
...
st.markdown('<h2 style="font-size:1em;">(3 Random and the 2 most creative submissions win a HTHC waterbottle each)</h2>', unsafe_allow_html=True)
