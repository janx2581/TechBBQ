...
st.markdown('<h1 style="text-align: center;">🔴⚪ HTHC AI competition! Your submissions below👇 🔴⚪️</h1>', unsafe_allow_html=True)
st.markdown('<h1 style="font-size:1.5em;">Create something creative about healthtech! Scan the QR code to enter the competition. The 2 most creative and 3 random submissions win a HTHC waterbottle each! Read more about the rules by scanning</h2>', unsafe_allow_html=True)
